...
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (4, '16.134.777/0001-89', 'Gomes Inovação', 'João Fernando Gomes EIRELI ME', 'EIRELI', '2009-03-02', 4);
